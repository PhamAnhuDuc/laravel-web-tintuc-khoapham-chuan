                ...
                @if(Auth::check())
                    <div class="well">
                        @if(session('thongbao'))
                            {{session('thongbao')}}
                        @endif
                        <h4>Viet binh luan ...<span class="glyphicon glyphicon-pencil"></span></h4>
                        <form role="form" action="comment/{{$tintuc->id}}" method="post"> <!--?? b?n kia bi?t m?nh mu?n cm trong tin n?o-->
                            @csrf
